...
namespace CollisionBuddy
{
	public static class CollisionCheck
	{
		...
		/// NOTE: this does not check for tunneling!  If the circles velocity is greater than it's radius,
		/// it can pass right through the line
		/// </summary>
		/// <param name="A">the circle to check</param>
		/// <param name="B">the line to check</param>
		/// <param name="closestPointA">if a collision is occurring, the closet point on the circle to the line</param>
		/// <param name="closestPointB">if a collision is occurring, the closest point on the line to the circle</param>
		/// <returns>true if the circle and line are colliding, false if not</returns>
		public static bool CircleLineCollision(Circle A, Line B, ref Vector2 closestPointA,
			ref Vector2 closestPointB)
		{
			...
			{
				//The closest point is a midpoint on the line segment
		...
		/// <summary>
		/// Given a rectangle and a circle that we assume is in that rectangle. 
		/// Find if the circle is hitting the wall, where it is hitting the wall,
		/// and where to move it to put it back in the box
		/// This function also prevents tunneling, if the circle totally leaves the rectangle it will pop back in
		/// </summary>
		...
		/// <param name="overlap">A vector that you can add to the circle's position to put it back in the rectangle</param>
		/// <returns>true if the circle is outside the edge of the rectangle, false if it is still all inside</returns>
